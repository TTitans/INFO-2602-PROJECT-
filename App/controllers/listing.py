...
def list_apartments():
    ...
    listings = Listing.query.order_by(Listing.created_at.desc()).paginate(page=page, per_page=9)
    return render_template('listings/view.html', listings=listings, title='Apartments')
...
def my_listings():
    ...
    return render_template('listings/my_listings.html', listings=listings, title='My Listings')
...
def create():
    ...
    if form.validate_on_submit():
        ...
        if form.amenities.data:
            amenities = Amenity.query.filter(Amenity.id.in_(form.amenities.data)).all()
    ...
    return render_template('listings/create.html', form=form, title='Create Listing')
...
def detail(apartment_id):
    ...
    return render_template('listings/detail.html', listing=listing, title=listing.title)
...
def edit(apartment_id):
    ...
    return render_template('listings/edit.html', form=form, listing=listing, title='Edit Listing')
